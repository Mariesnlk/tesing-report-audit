...
// contract PrivateDistributionMock is Ownable {
...
//             // msg.sender - owner -> incorrect logic

//             // _oddzToken.safeApprove(investors[i], availableTokens);
...
//         );
//         // TODO
//         _oddzToken.safeApprove(_msgSender(), tokensAvailable);
...
//             } else if (
//                 currentTimeStamp > initialCliff &&
//                 currentTimeStamp < vestingDuration
//             ) {
...
//                 );
//                 // console.log(
//                 //     "Everyday Percentage: %s, Days: %s, Current Unlock %: %s",
//                 //     everyDayReleasePercentage,
//                 //     noOfDays,
//                 //     currentUnlockedPercentage
//                 // );
